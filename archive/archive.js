...
function opena126Client() {
    // Get the selected version from the dropdown
    const versionSelect = document.getElementById('a126-client-version');
    const selectedVersion = versionSelect.value;
...
function openb173Client() {
    // Get the selected version from the dropdown
    const versionSelect = document.getElementById('b173-client-version');
    const selectedVersion = versionSelect.value;
